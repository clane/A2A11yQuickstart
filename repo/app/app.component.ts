...
@Component({
  ...
  template: `
      ...
      <modal-open-button #modalOpen (click)="enterModalContext()"  *ngIf="notModal">Loading...</modal-open-button>
...
export class WidgetDemoComponent {
  ...
  enterModalContext(){
    //Toggle the visibility of the modal and the other components
    this.modal = true;
    this.notModal = false; 
  }
